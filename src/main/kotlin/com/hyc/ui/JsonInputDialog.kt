...
import com.hyc.feedback.FormatJSONAction
import com.hyc.feedback.sendActionInfo
...
class JsonInputDialog(classsName: String, private val project: Project) : Messages.InputDialog(
        project,
        "Please input the JSON String and class name to generate Dart data class",
    ...
    private fun createJsonContentEditor(): Editor {
        ...
        val document = editorFactory.createDocument("").apply {
            ...
            addDocumentListener(object : com.intellij.openapi.editor.event.DocumentListener {
                override fun documentChanged(event: @NotNull DocumentEvent) = revalidate()

                override fun beforeDocumentChange(event: @NotNull DocumentEvent) = Unit
            })
        }
